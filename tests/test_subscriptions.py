...
class TestSubscriptionTracking:
    ...
    def test_manual_add_subscription(self):
        ...
        _subscriptions["gma2://console/status"].append(1)
    ...
    def test_remove_subscription(self):
        _subscriptions["gma2://console/status"].append(1)
        _subscriptions["gma2://console/status"].pop()
        # Empty list still exists in defaultdict
        assert get_subscription_count("gma2://console/status") == 0
