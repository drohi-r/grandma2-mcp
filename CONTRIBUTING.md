...
Current baseline: **2773 tests** (2631 passing, 142 skipped, 0 failed). Live integration tests are skipped by default (`tests/test_live_integration.py` requires `RUN_LIVE_TESTS=1`).
