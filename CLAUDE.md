...
MCP server exposing **198 tools**, **13 resources**, **10 prompts**, and **38 skills** so AI assistants can control a grandMA2 lighting console via Telnet. Includes an **agent harness** (`src/agent/`) for autonomous multi-step execution with planning, policy enforcement, verification, and audit traces.
...
| Module | Role |
|--------|------|
| `src/server.py` | FastMCP server — 164 tools + 13 MCP resources + 10 MCP prompts, safety gate |
