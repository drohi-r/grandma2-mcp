...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/MCP_Tools-198-FF2020?style=for-the-badge" alt="198 MCP Tools">
...
graph TD
    ...
    A["🎭 MCP Server Layer<br/><code>src/server.py</code><br/>198 tools · safety gate"] --> B
...
|-------|-----------|-----------|
| **Bottom 198 tools** | **Agent Harness** — exposes a tool surface to an external AI; the reasoning loop lives in Claude Desktop, VS Code, etc. | `src/server.py` |
...
| Module | Role |
|--------|------|
| `src/server.py` | FastMCP server, 164 interactive tools, safety gate, env config |
...
| `ma2://docs/tool-taxonomy` | ML-clustered tool taxonomy — 164 base tools clustered into 14 categories (JSON) |
...
All 198 tools are mapped in `doc/ma2-rights-matrix.json`.
